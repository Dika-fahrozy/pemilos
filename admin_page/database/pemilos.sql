...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2017 at 05:21 PM
...
('AD-001', 'Dika', '0c06a8fb5e56d84eeb612f47e3f5206a');

-- --------------------------------------------------------

--
-- Table structure for table `tab_calon`
--

CREATE TABLE IF NOT EXISTS `tab_calon` (
...
--
-- Dumping data for table `tab_calon`
--

INSERT INTO `tab_calon` (`gambar`, `id_calon`, `ketua_umum`, `ketua_1`, `ketua_2`, `visi`, `misi`) VALUES
('1.jpg', 1, 'Faisal Tanjung', 'Fahmi', 'Anisah', 'Kami akan menjadikan siswa/i SMK BPM menjadi Siswa/i yang kreatif dan aktif dalam hal rohani  maupun jasmani dan semoga kedepannya kami bisa menjadi ketua OSIS yang baik dan dapat menjalankan program - program kerja kami (AMIN)', '1. menumbuh kembangkan keimanan dan ketakwaan kepada tuhan yang esa, bagi selurh Siswa/i SMK BPM\r\n2. Menjadian Siswa/i SMK BPM menjadi Siswa/i yang disiplin dan menumbuhkan rasa kekeluargaan antar warga sekolah SMK BPM\r\n3. mengadakan kegiatan untuk menigkatkan kreatifitas dan bakat Siswa/i melalui program ekstrakulikuler dan berbagai organisasi yang ada'),
('2.jpg', 2, 'Hendri Ariles P', 'Yoki Pradana', 'Revani Chrisman', 'Menciptakan lingkungan Siswa/i SMK BPM yang memiliki sikap berkualitas, berpengetahuan luas, mempunyai sifat solidaritas yang tinggi, terbuka, aktif, kreatif dan inovatif melalui pengembangan organisasi yang berkualitas pula dengan landasan iman', '1. Memberi contoh tauladan yang baik kepada Siswa/i\r\n2. Meningkatkan kegiatan kerohanian serta pembinaan agama untuk menigkatkan keimanan serta ketakwaan kepada Tuhan Yang Maha Esa\r\n3. Mengajak Siswa/i untuk aktif dalam mengikuti ekstrakulikuler\r\n4. Mengadakan program - program kerja yan gbermanfaat dan berdaya guna'),
...
('151610053', 'RAZIP AHMAD NURRACHIM', 'L', 10, 'BELUM'),
...
('171810095', 'Mohamad Rahmat Fauzi', 'L', 0, 'BELUM'),
('171810094', 'Mochammad Nasrul Nugraha', 'L', 0, 'BELUM'),
('171810093', 'Mila', 'P', 0, 'BELUM'),
('171810091', 'Muhamad Al Idrus', 'L', 0, 'BELUM'),
('171810090', 'Laras Dwi Syahputri', 'P', 0, 'BELUM'),
('171810089', 'Ilham Teguh Prasetya', 'L', 0, 'BELUM'),
('171810088', 'Ilham Romadon', 'L', 0, 'BELUM'),
('171810087', 'Ikhsan Maulana', 'L', 0, 'BELUM'),
('171810086', 'Heriyana Muhazir', '', 0, 'BELUM'),
('171810085', 'Herawati', 'P', 0, 'BELUM'),
('171810084', 'Gusti Ngurah Agung Kencan', 'L', 0, 'BELUM'),
('171810083', 'Firdha Aulia Putri', 'P', 0, 'BELUM'),
('171810082', 'Ferdi Nando Petrus Sakka', 'L', 0, 'BELUM'),
('171810081', 'Eplin Deskayanti', 'P', 0, 'BELUM'),
('171810080', 'Dede Indra', 'P', 0, 'BELUM'),
('171810079', 'Bunga Tanjung Sari', 'P', 0, 'BELUM'),
('171810078', 'Ari Hidayat', 'L', 0, 'BELUM'),
('171810077', 'Ardhea Syarofah', 'P', 0, 'BELUM'),
('171810076', 'Anisa Neng', 'P', 0, 'BELUM'),
('171810075', 'Ahmad Marhaban', 'L', 0, 'BELUM'),
('171810074', 'Adela Nadindra', 'P', 0, 'BELUM'),
('171810073', 'Abdul Aziz', 'L', 0, 'BELUM'),
('171810072', 'Aa Andri', 'L', 0, 'BELUM'),
('171810071', 'Yunika Supriyanti', 'P', 0, 'BELUM'),
('171810070', 'Winda Agustin', 'P', 0, 'BELUM'),
('171810069', 'Wardah Hanifah', 'P', 0, 'BELUM'),
('171810068', 'Tiara Putri Dewi', 'P', 0, 'BELUM'),
('171810067', 'Tarisa', 'P', 0, 'BELUM'),
('171810066', 'Susi Ayuni', 'P', 0, 'BELUM'),
...
--
-- Table structure for table `tab_suara`
--

CREATE TABLE IF NOT EXISTS `tab_suara` (
  `nis` char(10) NOT NULL,
